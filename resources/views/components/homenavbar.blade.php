...
<header class="header">
    <!-- Logo Nav START -->
    <nav class="navbar navbar-light navbar-expand-xl px-5">
        <div class="container-fluid px-md-5">
            <!-- Logo START -->
            <a class="navbar-brand" href="#">
                <img class="light-mode-item navbar-brand-item" style="height:150px" src="{{ asset('kpgu-logo.png') }}"
                    alt="logo">
                <img class="dark-mode-item navbar-brand-item" style="height: 150px" src="{{ asset('kpgu-logo.png') }}"
                    alt="logo">
            </a>
            <!-- Logo END -->
            ...
            <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                @if (Session::has('student_user'))
                    ...
                    <li class="nav-item ms-3 dropdown">
                        ...
                        <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button"
                            ...
                            aria-expanded="false">
                            @if (Session::get('student_user')->avatar)
                                <img class="avatar-img rounded-2"
                                    src="{{ asset(Session::get('student_user')->avatar) }}" alt="avatar">
                            @else
                                <img class="avatar-img rounded-2" src="{{ asset('user.png') }}" alt="avatar">
                            @endif
                        </a>
                        ...
                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                            ...
                            <li class="px-3 mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    @else
                                        <div class="avatar me-3">
                                            <img class="avatar-img rounded-circle shadow" src="{{ asset('user.png') }}"
                                                alt="avatar">
                                        </div>
                                    @endif
                                    <div>
                                        <a class="h6 mt-2 mt-sm-0"
                                            href="#">{{ Session::get('student_user')->name }}</a>
                                        <p class="small m-0">{{ Session::get('student_user')->email }}</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="#"><i
                                        class="bi bi-bookmark-check fa-fw me-2"></i>My
                                    Book</a></li>
                            ...
                            <li><a class="dropdown-item bg-danger-soft-hover" href={{ route('studentLogout') }}><i
                ...
                @else
                    <li class="nav-item ms-2 d-none d-sm-block">
                        <a href="{{ route('studentlogin') }}" class="btn btn-sm btn-primary-soft mb-0"><i
