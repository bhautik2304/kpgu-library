...
<head>
    ...
    <title>KPGU Library | Login </title><!--begin::Primary Meta Tags-->
...
<body class="login-page bg-body-secondary">
    <div class="login-box">
        <div class="login-logo"> <a href="../index2.html">
                <a class="navbar-brand" href="#">
                    <img class="navbar-brand-item my-4" style="height: 150px" src="{{ asset('kpgu-logo.png') }}"
                        alt="logo">
                </a>
                <b>Library</b>Admin</a>
        </div> <!-- /.login-logo -->
