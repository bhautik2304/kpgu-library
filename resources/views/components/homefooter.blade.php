    ...
    <div class="container">
        <div class="row mx-auto">
            <div class="col-md-10 col-xl-6 mx-auto text-center">
                <!-- Logo -->
                <img class="mx-auto h-150px" src="{{ asset('kpgu-logo.png') }}" alt="logo">
                ...
                <!-- copyright text -->
                <div class="text-body-secondary text-primary-hover mt-3"> Copyrights ©2023 KPGU-LIBRARY. All rights
                    reserved by <a href="https://kpgu.ac.in/" class="text-body-secondary">KPGU</a>. </div>
            </div>
        </div>
